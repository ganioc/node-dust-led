...
function LEDPanel(options) {
  ...
  if (options.port === undefined) {
    throw new Error('no port LEDPanel()')
  }
...
LEDPanel.prototype.init = function () {
  ...
  this.bOpen = true // force it to be open

  this.packetCb = null

  this.on('packet', function (data) {
    if (that.packetCb === null) {
      console.log('empty packet callback')
      return
    }
    that.packetCb(data);
    that.packetCb = null
