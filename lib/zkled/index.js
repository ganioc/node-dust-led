...
LEDPanel.prototype.createTextParams = function (text, options) {
  ...
  var buf = facility.concatBuffers(bufWID, bufREV, bufSTYLE, bufFORMAT, bufENTRY, bufSPENTRY, bufDUENTRY, bufHIGHLIGHT, bufSPHL, bufDUHL, bufEXIT, bufSPEXIT, bufTIMES, bufCNT, bufText)
  console.log('params:')
  // console.log(buf)
...
LEDPanel.prototype.createTextHead = function (dataLen) {
  ...
  var buf = facility.concatBuffers(bufSF, bufCTRL, bufDES, bufSRC, bufTID, bufCMD)
